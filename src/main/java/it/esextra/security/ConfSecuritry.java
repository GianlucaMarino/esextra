package it.esextra.security;



import it.esextra.filter.CustomAuthenticationFilter;
import it.esextra.filter.CustomAuthorizationFilter;
...
class ConfSecuritry extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(POST, "/BranoController/**").hasAnyAuthority("ROLE_ADMIN");
        http.authorizeRequests().antMatchers(PUT, "/BranoController/**").hasAnyAuthority("ROLE_ADMIN");
        http.authorizeRequests().antMatchers(DELETE, "/BranoController/**").hasAnyAuthority("ROLE_ADMIN");
